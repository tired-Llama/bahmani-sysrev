...
```
```{r "report the summaries"}
if(export_summary){
    name = "meta-analysis results.pdf"
    sink(file =paste(export_path,name,sep = ""),type = "output")
    print(summary(sensetivity))
